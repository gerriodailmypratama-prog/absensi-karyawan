...
import {
  sb as sbBawaan, kodeClockout, KODE_SLOT_MS, LIBUR_HARI, LIBUR_MAX, rapikanPanggilan,
  EMBER_SELFIE, EMBER_PROFIL, EMBER_KTP, SUPABASE_URL, SUPABASE_KEY
} from './supabase-config.js';

export { kodeClockout, KODE_SLOT_MS, LIBUR_HARI, LIBUR_MAX };

// Klien yang dipakai. Bawaannya klien browser (sesi owner); uji otomatis bisa menggantinya.
let sb = sbBawaan;
